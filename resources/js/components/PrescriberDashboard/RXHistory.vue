                                    ...
                                    <tbody>
                                        <tr 
                                            ...
                                            >
                                                ...
                                                <td><span v-if="p.patient">{{ p.patient.name }}</span></td>
                                                <td><span v-if="p.patient">{{ p.patient.phone }}</span></td>
...
export default {
    ...
    methods: {
        getPPP(page = 1) {
            ...
            this.axios.get(`/api/prescriberHistory/${this.$auth.user().id}` + p).then(response => {
        ...
        details(data) {
            this.user = data;
            this.$router.push({ name: "PrescriberRxDetails", params:{id:data.id} })
        }
    }
};
</script>
