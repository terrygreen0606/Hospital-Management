    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <!--<<div class="tab-pane fade show" id="tab4" role="tabpanel" aria-labelledby="tab4">
                    <div class="table-responsive pmd-table-card">
                        <div class="row">
                            <div class="col-md-6">
                                <h2>Med Videos and Mapping</h2>
                            </div>
                            <div class="col-md-6">
                                <form
                                    enctype="multipart/form-data"
                            ...
                            <div class="col-md-12">
                                <table class="table pmd-table">
                                    <thead>
                                        <tr>
                                            <th>Video ID</th>
                                            <th>NCD9 Formatted</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="row in mvmData.data" :key="row.id">
                                            <td>{{ row.video_id }}</td>
                                            <td>{{ row.ncd9_formatted }}</td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <td colspan="6" class="text-left pl-2">
                                            <pagination
                                                :limit="1"
                                                :data="mvmData"
                                                @pagination-change-page="getMedVideos"
                                            ></pagination>
                                        </td>
                                    </tfoot>
                                </table>
...
const STATUS_INITIAL = 0,
    ...
    export default {
        ...
        methods: {
            ...
            //     let p = page == 1 ? "" : "&page=" + page;
            //     this.axios
            //         .get(`/api/patientEducation?type=mvm` + p)
            //         .then(response => {
            //             this.mvmData = response.data;
            //         });
            // },
            loadVideo(vid) {
                let addToSource = document.getElementById('vidSrc');
