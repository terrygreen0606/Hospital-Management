<template>
    ...
    <div class="container">
        <div class="row justify-content-md-center">
            ...
            <div class="col-lg-6 col-12" style="height: 100vh !important;">
                <div class="h-100 d-flex align-items-center justify-content-center h-100">
                    <div class="card disable-rounded-right mb-0 p-2 d-flex flex-column w-100">
                        <div class="card-header pb-3">
                            <div class="card-title">
                                <h4 class="text-center mb-0">Welcome Back</h4>
                                <small>Enter your phone number below to login your account</small>
                            </div>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="alert alert-success text-center" v-if="requested">
