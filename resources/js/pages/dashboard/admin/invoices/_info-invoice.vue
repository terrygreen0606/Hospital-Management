                        ...
                        <div class="card invoice-action-wrapper shadow-none border">
                            <div class="card-body">
                                <div class="invoice-action-btn">
                                    <button
                                        class="btn btn-primary btn-block invoice-send-btn text-left"
                                        @click="emailInvoice"
                                        v-if="$auth.check() && $auth.user().role == 'admin'"
                                        >
                                        <i class="bx bx-send float-left mr-1"></i>
                                        <span>Send Invoice Email</span>
                                    </button>
                                </div>
                                <div class="invoice-action-btn">
                                    <button
                                        class="btn btn-info btn-block invoice-send-btn text-left"
                                        @click="smsInvoice"
                                        v-if="$auth.check() && $auth.user().role == 'admin'"
                                        >
                                        <i class="bx bx-mail-send float-left mr-1"></i>
                                        <span>Send Invoice SMS</span>
                                    </button>
                                </div>
                                <div class="invoice-action-btn">
                                    <button @click="printSection" class="btn btn-light-primary btn-block invoice-print text-left">
                                        <i class="bx bx-printer float-left mr-1"></i>
                                ...
                                <div class="invoice-action-btn">
                                    <router-link
                                        ...
                                        >
                                        <i class='bx bx-dollar float-left mr-1'></i>
